...
var TransactionObserver = /** @class */ (function () {
     ...
     */
    TransactionObserver.observe = function (address, gw) {
        var _this = this;
        var subscription = this.subscriptions.get(address);
        if (subscription) {
            return;
        }
        ...
        subscription.addListener(address, function (e) {
            _this.cache.set(e.transactionHash, e.returnData);
     ...
     */
    TransactionObserver.outcome = function (txHash) {
        return __awaiter(this, void 0, void 0, function () {
            var tx;
            return __generator(this, function (_a) {
                tx = TransactionObserver.cache.get(txHash);
                if (tx) {
                    return [2 /*return*/, tx];
                }
                return [2 /*return*/, new Promise(function (resolve) {
                        TransactionObserver.incoming.once(txHash, function (d) {
                            resolve(d);
